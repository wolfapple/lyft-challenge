...
class BilinearUpsampling(Layer):
  # Simple bilinear upsampling layer. Works only with TF.
...
def Deeplabv3(weights_path=None, input_shape=(512, 512, 3), classes=21, backbone='mobilenetv2', OS=16, alpha=1.):
